...
privileged aspect WorkTemplateController_Roo_Controller {
    ...
    public String WorkTemplateController.findWorkTemplatesByDegreeAndTermEqualsForm(Model model) {
        model.addAttribute("degrees", java.util.Arrays.asList(Degree.class.getEnumConstants()));
    ...
    public String WorkTemplateController.findWorkTemplatesByDegreeAndTermEquals(@RequestParam("degree") Degree degree, @RequestParam("term") Term term, Model model) {
        model.addAttribute("worktemplates", WorkTemplate.findWorkTemplatesByDegreeAndTermEquals(degree, term).getResultList());
        return "worktemplates/list";
    }
    ...
    public Collection<Degree> WorkTemplateController.populateDegrees() {
