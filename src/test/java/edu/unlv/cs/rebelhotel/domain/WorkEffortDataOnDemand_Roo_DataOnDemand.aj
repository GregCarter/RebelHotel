...
privileged aspect WorkEffortDataOnDemand_Roo_DataOnDemand {
    ...
    @Autowired
    private WorkEffortDurationDataOnDemand WorkEffortDataOnDemand.workEffortDurationDataOnDemand;
    ...
    public WorkEffort WorkEffortDataOnDemand.getNewTransientWorkEffort(int index) {
        ...
        obj.setDuration(workEffortDurationDataOnDemand.getRandomWorkEffortDuration());
